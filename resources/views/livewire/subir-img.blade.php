    ...
    <div class="card shadow rounded-4 border-0">
        <div class="m-3">
            ...
            <form wire:submit.prevent="save">
                ...
                <div class="mb-3">
                    <label class="form-label">Describe la ubicación y características de el ave (Ejemplo: Tamaño, Color
                        y Hábitat)</label>
                ...
                <br>
                <div>
                    <button type="submit" @disabled($this->validation) class="btn btn-success ms-auto">Guardar</button>
                    <button class="btn btn-primary" onClick="window.location.reload();">Regresar al inicio</button>
                </div>
            </form>
        </div>
    </div>
